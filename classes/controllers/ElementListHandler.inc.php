...
/**
 * @file classes/controllers/grid/ElementListHandler.inc.php
 *
 * Copyright (c) 2000-2010 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class ElementListHandler
 * @ingroup classes_controllers
 *
 * @brief Class defining operations for element controllers (e.g. listbuilders and grids).
 */
...
class ElementListHandler extends PKPHandler {
	/** @var string controller's main title title */
	var $_title = '';
	...
	function getTemplate() {
		assert(false); // Should be handled by subclasses so a default template can be used if necessary
	}
	...
	function &getRowInstance() {
		assert(false); // Subclasses must implemented
	}
