<?php
	...
	if (!file_exists($init['baseDir'] . '/' . $init['publicDir'] . '/site/images/')) {
		...
		if(!file_exists($init['baseDir'] . '/' . $init['publicDir'] . '/site/') || !is_writeable($init['baseDir'] . '/' . $init['publicDir'] . '/site/')) {
	...
	if (Validation::isLoggedIn() && !file_exists($init['baseDir'] .'/' . $init['publicDir'] . '/site/images/' . $user->getUsername())) {
		...
		if(!file_exists($init['baseDir'] . '/' . $init['publicDir'] . '/site/images/') || !is_writeable($init['baseDir'] . '/' . $init['publicDir'] . '/site/images/')) {
			die(Locale::translate('installer.installFilesDirError'));
		}
